...
const Navbar = () => {
  ...
  return (
    ...
    <img
      src={assets.logo}
      alt="Logo"
      className="w-full h-full rounded-full filter brightness-75 opacity-70 transition-transform duration-1000 ease-in-out hover:rotate-[360deg] hover:opacity-100"
      style={{
    ...
    <img src={assets.cart_icon} className='w-5 min-5'/>
